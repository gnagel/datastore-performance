...
def _benchmark_SINGLE_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance):
    entity = model_instance._populate_entity(datastore.Entity)
    entity_proto = entity.ToPb()
    serialized = entity_proto.SerializeToString()
    ...
    for _ in range(SERIALIZATION_ITERATIONS):
        entity_proto = entity_pb.EntityProto(serialized)
        entity = datastore.Entity.FromPb(entity_proto)
        deserialized = model_instance.__class__.from_entity(entity)
...
def _benchmark_MULTI_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance):
    entity = model_instance._populate_entity(datastore.Entity)
    entity_proto = entity.ToPb()
    serialized = entity_proto.SerializeToString()
...
def _benchmark_SINGLE_LAZY_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance):
    entity = model_instance._populate_entity(datastore.Entity)
    entity_proto = entity.ToPb()
    serialized = entity_proto.SerializeToString()
...
def _benchmark_MULTI_LAZY_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance):
    entity = model_instance._populate_entity(datastore.Entity)
    entity_proto = entity.ToPb()
    serialized = entity_proto.SerializeToString()
...
def _benchmark_PROTOBUF_PROPERTY_SIZE(model_instance):
    entity = model_instance._populate_entity(datastore.Entity)
    entity_proto = entity.ToPb()
    serialized = entity_proto.SerializeToString()
...
def _benchmark_serialization(model_instance):
    ...
    test_group, delta = _benchmark_SINGLE_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance)
    results.append(create_result(model_instance, test_group, delta))

    test_group, delta = _benchmark_MULTI_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance)
    results.append(create_result(model_instance, test_group, delta))

    test_group, delta = _benchmark_SINGLE_LAZY_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance)
    results.append(create_result(model_instance, test_group, delta))

    test_group, delta = _benchmark_MULTI_LAZY_PROPERTY_ACCESS_TIMES_PROTOBUF_TO_MODEL(model_instance)
    results.append(create_result(model_instance, test_group, delta))

    test_group, delta = _benchmark_PROTOBUF_PROPERTY_SIZE(model_instance)
    results.append(create_result(model_instance, test_group, delta))
